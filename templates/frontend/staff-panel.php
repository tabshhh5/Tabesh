                        ...
                        <div class="order-card-body">
                            ...
                            <?php if ($order->status === 'processing'): 
                                ...
                                if ($printing_substatus):
                                    ...
                                    $additional_services = json_decode($printing_substatus->additional_services, true);
                            ...
                            <div class="printing-substatus-section" data-order-id="<?php echo esc_attr($order->id); ?>">
                                ...
                                <div class="printing-substatus-content" style="display: none;">
                                    ...
                                    <!-- Checklist -->
                                    <div class="printing-checklist">
                                        <!-- Cover Printing -->
                                        <label class="substatus-item">
                                            <input type="checkbox" 
                                                   class="substatus-checkbox" 
                                                   data-substatus="cover_printing"
                                                   <?php checked($printing_substatus->cover_printing, 1); ?>>
                                            <span class="substatus-label">
                                                <?php _e('چاپ جلد', 'tabesh'); ?>
                                                <?php if (!empty($printing_substatus->cover_printing_details)): ?>
                                                    <span class="substatus-details">(<?php echo esc_html($printing_substatus->cover_printing_details); ?>)</span>
                                                <?php endif; ?>
                                            </span>
                                        </label>
                                        
                                        <!-- Cover Lamination (conditional) -->
                                        <?php if (!empty($printing_substatus->cover_lamination_details) && $printing_substatus->cover_lamination_details !== 'بدون سلفون'): ?>
                                        <label class="substatus-item">
                                            <input type="checkbox" 
                                                   class="substatus-checkbox" 
                                                   data-substatus="cover_lamination"
                                                   <?php checked($printing_substatus->cover_lamination, 1); ?>>
                                            <span class="substatus-label">
                                                <?php _e('سلفون جلد', 'tabesh'); ?>
                                                <span class="substatus-details">(<?php echo esc_html($printing_substatus->cover_lamination_details); ?>)</span>
                                            </span>
                                        </label>
                                        <?php endif; ?>
                                        ...
                                        <label class="substatus-item">
                                            <input type="checkbox" 
                                                   class="substatus-checkbox" 
                                                   data-substatus="text_printing"
                                                   <?php checked($printing_substatus->text_printing, 1); ?>>
                                            <span class="substatus-label">
                                                <?php _e('چاپ متن کتاب', 'tabesh'); ?>
                                                <?php if (!empty($printing_substatus->text_printing_details)): ?>
                                                    <span class="substatus-details">(<?php echo esc_html($printing_substatus->text_printing_details); ?>)</span>
                                                <?php endif; ?>
                                            </span>
                                        </label>
                                        ...
                                        <label class="substatus-item">
                                            <input type="checkbox" 
                                                   class="substatus-checkbox" 
                                                   data-substatus="binding"
                                                   <?php checked($printing_substatus->binding, 1); ?>>
                                            <span class="substatus-label">
                                                <?php _e('صحافی', 'tabesh'); ?>
                                                <?php if (!empty($printing_substatus->binding_details)): ?>
                                                    <span class="substatus-details">(<?php echo esc_html($printing_substatus->binding_details); ?>)</span>
                                                <?php endif; ?>
                                            </span>
                                        </label>
                                        ...
                                        <?php if (!empty($additional_services)): ?>
                                            <?php foreach ($additional_services as $service): ?>
                                                <label class="substatus-item">
                                                    <input type="checkbox" 
                                                           class="substatus-checkbox additional-service" 
                                                           data-substatus="additional_service"
                                                           data-service-name="<?php echo esc_attr($service['service']); ?>"
                                                           <?php checked(!empty($service['completed']), true); ?>>
                                                    <span class="substatus-label">
                                    ...
                                    <?php if ($printing_substatus->completed_at): ?>
                                    <div class="completion-notice">
                                        <span class="completion-icon">✅</span>
                                        <span class="completion-text">
                                            <?php 
                                            printf(
                                                __('تکمیل شده در %s', 'tabesh'),
                                                date_i18n('Y/m/d - H:i', strtotime($printing_substatus->completed_at))
                                            );
                                            ?>
                                        </span>
                                    </div>
                            ...
                            <?php 
                                endif; // if ($printing_substatus)
                            endif; // if ($order->status === 'processing') 
                            ?>
